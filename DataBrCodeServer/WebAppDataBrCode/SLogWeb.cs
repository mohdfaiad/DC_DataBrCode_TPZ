...
namespace WebAppDataBrCode
{
    public static class SLogWeb
    {
        ...
        private static List<ElemTsdLog> BufferOnline = null;
        ...
        public static DataTable GetDataTableTSDOnline()
        {
            if (BufferOnline == null)
                return null;
            DataTable R = new DataTable();
            R.TableName = "LogWebSTSD";
            //Создаем столбцы
            DataColumn colNN = new DataColumn("N", typeof(String));
            R.Columns.Add(colNN);
    ...
    public class ElemTsdLog
    {
        ...
        public string MacAdress { get; set; }
        public string ClientVersion { get; set; }
        public ElemTsdLog(string _Login, string _ClientVersion, string _MacAdress, string _DnsNames)
        {
            Time = DateTime.Now;
            DnsNames = _DnsNames;
            MacAdress = _MacAdress;
        ...
        public void Check(string _Login, string _ClientVersion)
        {
            Time = DateTime.Now;
            Login = _Login;
            ClientVersion = _ClientVersion;
